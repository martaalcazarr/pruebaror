...
class MotorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create motor" do
    assert_difference("Motor.count") do
      post motors_url, params: { motor: { description: @motor.description, equipment_type_id: @motor.equipment_type_id, name: @motor.name, photo: @motor.photo, user_id: @motor.user_id } }
    end
  ...
  test "should update motor" do
    patch motor_url(@motor), params: { motor: { description: @motor.description, equipment_type_id: @motor.equipment_type_id, name: @motor.name, photo: @motor.photo, user_id: @motor.user_id } }
