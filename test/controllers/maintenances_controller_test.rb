...
class MaintenancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create maintenance" do
    assert_difference("Maintenance.count") do
      post maintenances_url, params: { maintenance: { city_id: @maintenance.city_id, date: @maintenance.date, email: @maintenance.email, maintenance_type_id: @maintenance.maintenance_type_id, motor_id: @maintenance.motor_id, motor_name: @maintenance.motor_name } }
    end
  ...
  test "should update maintenance" do
    patch maintenance_url(@maintenance), params: { maintenance: { city_id: @maintenance.city_id, date: @maintenance.date, email: @maintenance.email, maintenance_type_id: @maintenance.maintenance_type_id, motor_id: @maintenance.motor_id, motor_name: @maintenance.motor_name } }
